...
do
  ...
  local servers = {
    -- Kotlin is configured by kotlin.nvim below. It must not also be enabled
    -- here, otherwise the plain nvim-lspconfig client wins and jar:// library
  ...
  vim.pack.add {
    ...
    gh 'stevearc/oil.nvim', -- required by kotlin.nvim
    gh 'folke/trouble.nvim', -- required by kotlin.nvim
  }
  ...
  vim.list_extend(ensure_installed, {
    -- kotlin.nvim owns the Kotlin client setup, but Mason still installs the
    -- language server used by it.
    'kotlin-lsp',
